...
DEFAULT_SETTINGS = {
    ...
    # Browser logging settings (minimal defaults to prevent Ngrok rate limiting)
    ...
    "browser_logging_buffer_size": 20,     # Maximum logs to buffer before flush (20-500) - minimal default
