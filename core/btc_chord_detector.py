...
# BTC is located at ../essentiatest/BTC-ISMIR19 relative to stemtube_dev_v1.2
BTC_PATH = os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(__file__)), '..', 'essentiatest', 'BTC-ISMIR19'))
